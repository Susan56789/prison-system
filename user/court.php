			...
			<td>
				...
				<form action="validatecourt.php" method="post">
					<table bgcolor="white" height="431" border="0" align="center" width="50%">
						...
						<td width="66%" bgcolor="#FFFFFF"><input type="text" name="Nationalid" size=8 maxlength=8 placeholder="99999" /></td>
		</tr>
		<tr>
			<td bgcolor="#FFFFFF"><b>File Number:</b></td>
			<td bgcolor="#FFFFFF"><input type="text" name="Filenum" size=6 maxlength=7 placeholder="NBI-9999" /></td>
		</tr>
		<!-- <tr> 
