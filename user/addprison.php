		...
		<tr>
			<td>
				...
				<div id="content">
					...
					<span class=''>*</span> This is a required field
					<form action='validatenew.php' method="POST">

						<label for="prisonid">Prison Id:</label>
						<input name="prisonid" class="prisonid" size=4 maxlength=8 size=30 type="text" placeholder="NBI-00001" /> *
						</br></br>

						<label for="prisonname">Prison Name:</label>
						<input name="prisonname" class="prisonname" size=4 maxlength=8 size=30 type="text" placeholder="KASARANI" /> *
						</br></br>
			<td>
			...
			<td><label for="on">Date of construction:</label>
				...
				<input type="text" name="day" size=4 maxlength=2 placeholder="DD" /><br>
