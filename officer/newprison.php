                ...
                <div id="content" class="ctrdiv">
                    <form id="frmReg" method="POST" action="validatenewprison.php">
                        ...
                        <div class="control_input">
                            <label for="Pno" class="label">Prison No</label><input type="text" id="pno" name="pno" size=5 maxlength=5 class="reg_fields" placeholder="-XXXX/XX" />
                        </div>
                        <div class="control_input">
                            <label for="Pname" class="label">Prison Name</label><input type="text" id="pname" name="pname" class="reg_fields" placeholder="xxx" />
                        </div>

                        <div class="control_input">
                            <label for="location" class="label">Location</label><input type="text" id="location" name="location" class="reg_fields" placeholder="Mombasa" />
                        </div>
                        ...
                        <div class="control_input">
                            <div style="display: inline-block;">
                                <table>
                                    ...
                                    <td style="margin: 0; padding: 0;">
                                        <input type="number" placeholder="Enter Capacity" id="capacity" name="capacity" class="reg_fields" style="margin: 0 0 0 -5px; height: 36px;  display:block;" />
